...
const Footer = () => {
    return (
        <footer>
            <div className='px-4 py-4 md:py-10 bg-white'>
                <div className='xxl:px-20'>
                    <div className='flex flex-col gap-3 md:gap-5 items-center justify-center mb-5 md:mb-8'>
                        <div className='flex items-center flex-col'>
                            <p className='text-[7px] md:text-[9.27px] font-bold tracking-[1%] plus-jakarta'>AN ISO 9001:2015 CERTIFIED INSTITUTE</p>
                            <img src={Logo} alt="Logo" className='md:h-[49.35px] h-[37px]' />
                        </div>

                        <p className='opacity-60 leading-[19.12px] md:leading-[27.32px] text-sm md:text-xl max-w-[680px] w-full mx-auto text-center'>We’re reimagining how you buy, sell and rent. It’s now easier to get into a place you love. So let’s do this, together.</p>
                    </div>
                        ...
                        <div className='flex-1'>
                            <div className='flex gap-3 md:gap-6 items-center md:mb-8'>
                                <div className='flex flex-col gap-1 order-2 md:order-1'>
                                    <img src={Qr} alt="Qr" className='md:w-[120px] w-[72px] md:h-[120px] h-[72px]' />
                                    <p className='block md:hidden opacity-50 text-xs font-medium text-center'>Click for Map</p>
                                </div>
                                <div className='flex gap-2 md:gap-4 flex-col flex-1 order-1 md:order-2'>
                                    <div className='flex items-center gap-2'>
                                        <img src={LocationIcon} alt="LocationIcon" className='block md:hidden w-4 h-4' />
                                        <h3 className='plus-jakarta font-bold text-xl md:text-[40px] leading-[24px] md:leading-[48px] text-[#15508B] flex-1'>
                                            Branch - 1 (<strong className='text-[#000000A3]'>Adajan</strong>)
                                        </h3>
                                    </div>
                                    <div className='flex items-center gap-2'>
                                        <img src={PhoneIcon} alt="PhoneIcon" className='w-4 h-4 md:h-7 md:w-7' />
                                        <p className='text-[#15508B] leading-[19.2px] md:leading-[33.6px] text-base md:text-[28px] font-bold plus-jakarta'>+91 90815 45151</p>
                                    </div>

                                    <p className='block md:hidden text-sm font-normal leading-[16.8px]'>
                                        UG-1, 1st Floor, V3 Corner, Honey Park Rd, Adajan, Surat - 395009
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex gap-3 md:gap-6 items-center md:mb-8'>
                                ...
                                <div className='flex gap-2 md:gap-4 flex-col flex-1 order-1 md:order-2'>
                                    <div className='flex items-center gap-2'>
                                        <img src={LocationIcon} alt="LocationIcon" className='block md:hidden w-4 h-4' />
                                        <h3 className='plus-jakarta font-bold text-xl md:text-[40px] leading-[24px] md:leading-[48px] text-[#15508B] flex-1'>
                                            Branch - 2 (<strong className='text-[#000000A3]'>Vesu</strong>)
                                        </h3>
                                    </div>
                                    <div className='flex items-center gap-2'>
                                        <img src={PhoneIcon} alt="PhoneIcon" className='w-4 h-4 md:h-7 md:w-7' />
                                        <p className='text-[#15508B] leading-[19.2px] md:leading-[33.6px] text-base md:text-[28px] font-bold plus-jakarta'>+91 99780 82823</p>
                                    </div>

                                    <p className='block md:hidden text-sm font-normal leading-[16.8px]'>
                                        M-40, 2nd Floor, Someshwar Square, Near VNSGU Rd, Vesu, Surat - 395007
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className='flex items-start md:items-center justify-start md:justify-center gap-3 md:gap-12 flex-col md:flex-row mb-5 md:mb-10'>
                        <div className='flex items-center gap-3'>
                            ...
                            <p className='text-[#15508B] text-sm md:text-xl font-semibold md:font-bold leading-[19.12px] md:leading-[24px] plus-jakarta'>+91 99780 82823</p>
                        </div>

                        <div className='flex items-center gap-3'>
                            <img src={MailEnvelopeIcon} alt="Mail Envelope Icon" />
                            <p className='text-[#15508B] text-xl font-bold leading-[24px] plus-jakarta'>info@easyskill.in</p>
                        </div>
                    </div>
                </div>
            </div>
